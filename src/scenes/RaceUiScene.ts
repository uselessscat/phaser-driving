...
export class RaceUiScene extends BaseScene {
	...
	public create(gameScene: GameScene): void {
		...
		this.timeLargeText = this.add
			.bitmapText(this.scale.gameSize.width / 2 + 30, 5, 'numbers', '000', 32)
			.setOrigin(1, 0)
			.setTint(0xffcccc);
		this.timeSmallText = this.add
			.bitmapText(this.scale.gameSize.width / 2 + 33, 8, 'numbers', '000', 16)
			.setOrigin(0, 0)
			.setTint(0xffcccc);
